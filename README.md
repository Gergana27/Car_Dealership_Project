...
After setting up the project, you can run the application using the `Startup` class, which serves as the entry point.
The application will prompt you to enter inputs directly in the console. 
